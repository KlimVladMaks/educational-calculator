...
class EduTypesFrame(BaseFrame):
    ...
    def create_frame(self):
        ...
        self.add_button = ttk.Button(
            self, text="Добавить вид обучения", command=self.open_add_widget)
    ...
    def delete_selected(self):
        ...
        self.db.edu_types.delete(str(values[0]))
    ...
    def open_edit_widget(self):
        ...
        item_data = self.table.tree.item(item)
        values = item_data['values']
        edu_type_name = str(values[0])
        self.editable_type = edu_type_name
        self.edit_widget = InputWidget(self, "Название", "Сохранить",
                                       self.edit_edu_type, self.cancel_edit, edu_type_name)
    ...
    def open_add_widget(self):
        ...
        self.add_widget = InputWidget(
            self, "Название:", "Добавить", self.add_edu_type, self.cancel_add)
    ...
    def edit_edu_type(self):
        edited_type = self.edit_widget.entry.get()
        self.db.edu_types.update(self.editable_type, edited_type)
        self.update_table()
